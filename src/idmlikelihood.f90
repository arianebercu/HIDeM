...
!---------- calcul de la vraisemblance ------------------
	 ...
	 if (nva01 .gt. 0) then 
	vet01 = dot_product(bh((npar0 - nva01 - nva12 - nva02 + 1) : (npar0 - nva12 - nva02)), ve01(i, 1:nva01))
	end if
    if (nva02 .gt. 0) vet02 = dot_product(bh((npar0 - nva12 - nva02 + 1) : (npar0 - nva12)), ve02(i, 1:nva02))
    if (nva12 .gt. 0) vet12 = dot_product(bh((npar0 - nva12 + 1) : npar0), ve12(i, 1:nva12))
...
!============================================================================================= 
        ...
        double precision,dimension(-2:(n+3))::zi
        double precision,dimension(-2:(n-1))::the 
		double precision,dimension(-2:(n-1))::ms,is
        is = 0
        ms = 0 
...
!==========================  SUSP  ===========================================================
!===================== calculate splines distribution ========================================
!===================== needed change index mapping    ========================================
!============================================================================================= 



        subroutine suspindex(x,the,n,su,lam,zi,gl)

        implicit none
        
        integer::j,k,n,i
        double precision::x,ht,ht2,h2,som,htm,h2t,h3,h2n,hn, &
        im,im1,im2,mm1,mm3,ht3,hht,h4,h3m,hh3,hh2,mm,im3,mm2,h,hh
		double precision,intent(inout)::gl,lam,su
        double precision,dimension(1:(n+6))::zi
        double precision,dimension(1:(n+2))::the 
        ...
        if(x.ge.zi(n+3))then
                ...
                gl = som
                lam = 4.d0*the(n+2)/(zi(n+3)-zi(n+2))
        endif
...
res0202num,res0212num,res1212num,v01,v02,v12)
	...
	fcdenum,fc01num,fc02num,fc12num, & 
	fc0101num,fc0102num,fc0112num,fc0202num,fc0212num,fc1212num
        ...
        xr = 0.5d+00*(b-a)
   		...
   		call fonct(xm,the12,ri12,gl12,su12)
    		...
    		fc01num=fcdenum*(1-(gl01*v01))
		fc02num=fcdenum*gl02*v02
		fc12num=fcdenum*gl12*v12
		fc0101num=fcdenum*(((1-gl01*v01)**2)-gl01*v01)
		fc0102num=fcdenum*gl02*v02*gl01*v01
		fc0112num=fcdenum*gl12*v12*gl01*v01
		fc0202num=fcdenum*gl02*v02*gl02*v02
		fc0212num=fcdenum*gl02*v02*gl12*v12
		fc1212num=fcdenum*gl12*v12*gl12*v12
		...
		do j=1,3
			...
			f101num=f1denum*(1-(gl01*v01))
			f102num=f1denum*gl02*v02
			f112num=f1denum*gl12*v12

			f10101num=f1denum*(((1-gl01*v01)**2)-gl01*v01)
			f10102num=f1denum*gl02*v02*gl01*v01
			f10112num=f1denum*gl12*v12*gl01*v01
			f10202num=f1denum*gl02*v02*gl02*v02
			f10212num=f1denum*gl02*v02*gl12*v12
			f11212num=f1denum*gl12*v12*gl12*v12
			...
			f201num=f2denum*(1-(gl01*v01))
			f202num=f2denum*gl02*v02
			f212num=f2denum*gl12*v12

			f20101num=f2denum*(((1-gl01*v01)**2)-gl01*v01)
			f20102num=f2denum*gl02*v02*gl01*v01
			f20112num=f2denum*gl12*v12*gl01*v01
			f20202num=f2denum*gl02*v02*gl02*v02
			f20212num=f2denum*gl02*v02*gl12*v12
			f21212num=f2denum*gl12*v12*gl12*v12
...
!================================  qgaussweibderiv  ==========================================
!=== for derivatives approximation out a 15 point Gauss-Kronrod quadrature rule for weib =====
!=== all parameters first and second derivatives =============================================
!=============================================================================================  
...
res0202num,res0212num,res1212num,v01,v02,v12)
	...
	f201num, f202num, f212num, f20101num,f20102num,f20112num,&
	f20202num,f20212num,f21212num,&
	su01,ri01,ri12,su12,su02,ri02,fcdenum,fc01num,fc02num,fc12num
	...
	double precision f1the0101dsquare, f2the0101dsquare, &
	f1the0202dsquare, f2the0202dsquare,&
	...
	fcthe1212square,fcthe0101dsquare,fcthe0202dsquare,fcthe1212dsquare
     ...
     integer::j,jtw,jtwm1
		...
		fcthe01=fcdenum*gl01*v01*LOG(xm)
		fcthe02=fcdenum*gl02*v02*LOG(xm)
		fcthe12=fcdenum*gl12*v12*LOG(xm)

		fcthe0101=fcdenum*((gl01*v01)**2)*LOG(xm)
		fcthe0202=fcdenum*((gl02*v02)**2)*LOG(xm)
		fcthe1212=fcdenum*((gl12*v12)**2)*LOG(xm)

		fcthe0101dsquare=&
		fcdenum*((gl01*v01)**2)*(LOG(xm)**2)
		fcthe0202dsquare=&
		fcdenum*((gl02*v02)**2)*(LOG(xm)**2)
		fcthe1212dsquare=&
		fcdenum*((gl12*v12)**2)*(LOG(xm)**2)

		fcthe0101square=&
		fcdenum*(gl01*v01)*(LOG(xm)**2)
		fcthe0202square=&
		fcdenum*(gl02*v02)*(LOG(xm)**2)
		fcthe1212square=&
		fcdenum*gl12*v12*(LOG(xm)**2)
		...
		fcthe0102=&
		fcdenum*(gl01*v01)*(gl02*v02)*LOG(xm)
		fcthe0112=&
		fcdenum*(gl01*v01)*(gl12*v12)*LOG(xm)
		fcthe0212=&
		fcdenum*(gl02*v02)*gl12*v12*LOG(xm)

		fcthe0102square=&
		fcdenum*(gl01*v01)*(gl02*v02)*(LOG(xm)**2)
		fcthe0112square=&
		fcdenum*(gl01*v01)*(gl12*v12)*(LOG(xm)**2)
		fcthe0212square=&
		fcdenum*(gl02*v02)*gl12*v12*(LOG(xm)**2)
		...
		do j=1,3
			...
			f1the01=f1denum*gl01*v01*LOG(xx)
			f1the02=f1denum*gl02*v02*LOG(xx)
			f1the12=f1denum*gl12*v12*LOG(xx)

			f1the0101=f1denum*((gl01*v01)**2)*LOG(xx)
			f1the0202=f1denum*((gl02*v02)**2)*LOG(xx)
			f1the1212=f1denum*((gl12*v12)**2)*LOG(xx)

			f1the0101dsquare=&
		f1denum*((gl01*v01)**2)*(LOG(xx)**2)
			f1the0202dsquare=&
		f1denum*((gl02*v02)**2)*(LOG(xx)**2)
			f1the1212dsquare=&
		f1denum*((gl12*v12)**2)*(LOG(xx)**2)

			f1the0101square=&
		f1denum*(gl01*v01)*(LOG(xx)**2)
			f1the0202square=&
		f1denum*(gl02*v02)*(LOG(xx)**2)
			f1the1212square=&
		f1denum*gl12*v12*(LOG(xx)**2)
		...
		f1denum*(LOG(xx)**2)
			...
			f1the0102=&
		f1denum*(gl01*v01)*(gl02*v02)*LOG(xx)
			f1the0112=&
		f1denum*(gl01*v01)*(gl12*v12)*LOG(xx)
			f1the0212=&
		f1denum*(gl02*v02)*gl12*v12*LOG(xx)

			f1the0102square=&
		f1denum*(gl01*v01)*(gl02*v02)*(LOG(xx)**2)
			f1the0112square=&
		f1denum*(gl01*v01)*(gl12*v12)*(LOG(xx)**2)
			f1the0212square=&
		f1denum*(gl02*v02)*gl12*v12*(LOG(xx)**2)
			...
			f20101num=f2denum*(((1-gl01*v01)**2)-&
			gl01*v01)
			f20102num=f2denum*gl02*v02*gl01*v01
			f20112num=f2denum*gl12*v12*gl01*v01
			f20202num=f2denum*gl02*v02*gl02*v02
			...
			!write(6,*) "xx",xx
			!write(6,*) "LOG(xx)",LOG(xx)
			f2the01=f2denum*gl01*v01*LOG(xx)
			f2the02=f2denum*gl02*v02*LOG(xx)
			f2the12=f2denum*gl12*v12*LOG(xx)

			f2the0101=f2denum*((gl01*v01)**2)*LOG(xx)
			f2the0202=f2denum*((gl02*v02)**2)*LOG(xx)
			f2the1212=f2denum*((gl12*v12)**2)*LOG(xx)

			f2the0101dsquare=&
		f2denum*((gl01*v01)**2)*(LOG(xx)**2)
			f2the0202dsquare=&
		f2denum*((gl02*v02)**2)*(LOG(xx)**2)
			f2the1212dsquare=&
		f2denum*((gl12*v12)**2)*(LOG(xx)**2)

			f2the0101square=&
		f2denum*(gl01*v01)*(LOG(xx)**2)
			f2the0202square=&
		f2denum*(gl02*v02)*(LOG(xx)**2)
			f2the1212square=&
		f2denum*gl12*v12*(LOG(xx)**2)
		...
		f2denum*(LOG(xx)**2)
			...
			f2the0102=&
		f2denum*(gl01*v01)*(gl02*v02)*LOG(xx)
			f2the0112=&
		f2denum*(gl01*v01)*(gl12*v12)*LOG(xx)
			f2the0212=&
		f2denum*(gl02*v02)*gl12*v12*LOG(xx)

			f2the0102square=&
		f2denum*(gl01*v01)*(gl02*v02)*(LOG(xx)**2)
			f2the0112square=&
		f2denum*(gl01*v01)*(gl12*v12)*(LOG(xx)**2)
			f2the0212square=&
		f2denum*(gl02*v02)*gl12*v12*(LOG(xx)**2)
	 	...
	 	do j=1,4
			...
			f10101num=f1denum*(((1-gl01*v01)**2)-&
			gl01*v01)
			f10102num=f1denum*gl02*v02*gl01*v01
			f10112num=f1denum*gl12*v12*gl01*v01
			f10202num=f1denum*gl02*v02*gl02*v02
...
!================================  qgaussweibderiv  ==========================================
!=== for derivatives approximation out a 15 point Gauss-Kronrod quadrature rule for weib =====
!=== all parameters first and second derivatives only diagonal terms =========================
!=============================================================================================  

			
subroutine qgaussweibbetaderivdiag(a,b,the01,the02,the12,resdenum,&

resthe01,resthe02,resthe12,resthenum,resthenumsquare,&
resthe0101,resthe0202,resthe1212,&
resthe0101square,&
resthe0202square,resthe1212square,&
resthe0101dsquare,resthe0202dsquare,resthe1212dsquare,&
res01num,res02num,res12num,res0101num,res0101numbis, &
res0202num,res1212num,v01,v02,v12)
	...
	use quadrature_15data
        implicit none
         ...
         double precision dx,xm,xr,reskdenum,&
         resdenum,resk01num,res01num,resk02num,res02num, & 
	resk12num,res12num,resk0101num,res0101num, &
	resk0202num,res0202num, &
	resk1212num,res1212num, &
	resk0101numbis,res0101numbis,&
	resthe01,resthe02,resthe12,resthe0101,&
	resthenum,resthenumsquare,resthe0202,resthe1212,&
	reskthe01,reskthe02,reskthe12,reskthe0101,&
	reskthe0202,reskthe1212,&
	reskthenum,reskthenumsquare, resthe0101square,reskthe0101square,&
	resthe0202square,reskthe0202square,&
	resthe1212square,reskthe1212square,resthe0101dsquare,reskthe0101dsquare,&
	resthe0202dsquare,reskthe0202dsquare,&
	resthe1212dsquare,reskthe1212dsquare,&
	v01,v02,v12
	...
	fcthe1212square,fcthe0101dsquare,fcthe0202dsquare,fcthe1212dsquare
     ...
     integer::j,jtw,jtwm1
		...
		fc0101num=fcdenum*(((1-gl01*v01)**2)-&
			gl01*v01)
		fc0202num=fcdenum*gl02*v02*gl02*v02
		fc1212num=fcdenum*gl12*v12*gl12*v12
	...
	!write(6,*) "reskdenum",reskdenum
		...
		!write(6,*) "end qgauss calculation"
          ...
          end subroutine qgaussweibbetaderivdiag

!=============================================================================================        
!================================  qgaussweibderiv  ==========================================
!=== for derivatives approximation out a 15 point Gauss-Kronrod quadrature rule for weib =====
!=== all parameters first derivatives ======================================================
!=============================================================================================  

subroutine qgaussweibbetafirstderiv(a,b,the01,the02,the12,resdenum,&
resthe01,resthe02,resthe12,resthenum,&
...
v01,v02,v12)
	...
	f1thenum,f2thenum,fcthe01, fcthe02, fcthe12,fcthenum
	...
	!write(6,*) "reskdenum",reskdenum
		...
		!write(6,*) "end qgauss calculation"
          ...
          end subroutine qgaussweibbetafirstderiv
...
!================================  qgaussweibderiv  ==========================================
!=== for derivatives approximation out a 15 point Gauss-Kronrod quadrature rule for weib =====
!========================= looking only at first derivative on beta parameter=================
!=============================================================================================  
...
!================================ M-spline baseline risk ===================
!====================== first derivatives of beta parameters ===============
!=============================================================================================  
...
!=============================================================================================  
!======================= Calculate derivatives of loglik with weibull baseline risk ==========
!======================== only diagonal for all parameters =================================================
!=============================================================================================  


subroutine derivaweiballparadiag(b0,np0,npar0,bfix0,fix0,c0,no0,ve010,ve120,ve020,&
        dimnva01,dimnva12,dimnva02,nva01,nva12,nva02,t00,&
        t10,t20,t30,troncature0,likelihood_deriv)
        ...
        double precision::res2denum,res201num,res202num,res212num, &
	res20101num,res20202num,res21212num,res20101numbis,&
	res2thenum,res2thenumsquare,res2the01,res2the02,res2the12,&
	res2the0101,res2the0202,res2the1212,&
	res2the0101square,res2the0202square,&
	res2the1212square,res2the0101dsquare,res2the0202dsquare,&
	res2the1212dsquare,vet01,vet12,vet02,resint,v,u1,u2,u3
	...
	nvamax12weib12=nvamax+nvaweib
	
	nvamax01=nvamax12weib12+nva01nofix
	nvamax0102=nvamax01
	nvamax0112=nvamax0102
	
	nvamax02=nvamax0112+nva02nofix
	nvamax0212=nvamax02
	nvamax12=nvamax0212+nva12nofix
...
!write(6, *) "subject ",i
    ...
    if (nva12 .gt. 0) vet12 = dot_product(bh((npar0 - nva12 + 1) : npar0), ve12(i, 1:nva12))
			...
			call fonct(t3(i),the12,ri12,gl12,su12)
			!call logapproxi(t1(i),t2(i),res2denum) approxi log(x) OK
			call qgaussweibbetaderivdiag(t1(i),t2(i),the01,&
			the02,the12,res2denum,res2the01,res2the02,&
			res2the12,res2thenum,res2thenumsquare,&
			res2the0101,res2the0202,&
			res2the1212,res2the0101square,&
			res2the0202square,&
			res2the1212square,res2the0101dsquare,&
			res2the0202dsquare,res2the1212dsquare,&
			res201num,res202num,res212num,res20101num,&
...
!here!
			...
			call qgaussweibbetaderivdiag(t1(i),t3(i),the01,&
			the02,the12,res2denum,res2the01,res2the02,&
			res2the12,res2thenum,res2thenumsquare,&
			res2the0101,res2the0202,&
			res2the1212,res2the0101square,&
...
subroutine derivaweiballparafirstderiv(b0,np0,npar0,bfix0,fix0,c0,no0,ve010,ve120,ve020,&
        dimnva01,dimnva12,dimnva02,nva01,nva12,nva02,t00,&
        t10,t20,t30,troncature0,likelihood_deriv)
...
123     continue 
    ...
    end subroutine derivaweiballparafirstderiv
...
v01,v02,v12,z01,z02,z12,n01,n02,n12)
	...
	su01,ri01,ri12,su12,su02,ri02,fcdenum
...
double precision,dimension(-2:(n01+3))::z01
	double precision,dimension(-2:(n02+3))::z02
	double precision,dimension(-2:(n12+3))::z12
	

    double precision,dimension(-2:(n01-1))::the01,f1i01num, &
	f2i01num,fci01num,f1m01num, &
	f2m01num,fcm01num,reski01num,&
	resi01num,reskm01num,resm01num,si01,sm01
	
	
    double precision,dimension(-2:(n12-1))::the12,f1i12num, &
	f2i12num,fci12num,resi12num,reski12num, &
	si12,sm12
	
	
    double precision,dimension(-2:(n02-1))::the02,f1i02num, &
	...
	si02,sm02
        ...
        xr = 0.5d+00*(b-a)
			...
			call susp(xm,the01,n01,su01,ri01,z01,gl01)
		...
		fci01num=fcdenum*si01
		fci02num=fcdenum*si02
		fci12num=fcdenum*si12
		...
		do j=1,3
			...
			f1denum =(su01**v01)*(su02**v02)*ri01*v01/(su12**v12)
			f1i01num=f1denum*si01
			f1i02num=f1denum*si02
			f1i12num=f1denum*si12
			...
			f2denum =(su01**v01)*(su02**v02)*ri01*v01/(su12**v12)
			f2i01num=f2denum*si01
			f2i02num=f2denum*si02
			f2i12num=f2denum*si12
...
resi1212num,v01,v02,v12,z01,z02,z12,n01,n02,n12)
	...
	fcdenum
     ...
     double precision gl01,gl12,gl02
     integer::j,jtw,jtwm1,k,m,l,w,itt,n01,n02,n12
	...
	reski1212num,fci1212num,f1i1212num,f2i1212num
		...
		!write(6,*) "su12",su12
		!write(6,*) "ri01",ri01
		num = (su01**v01)*(su02**v02)/(su12**v12) 
    	fcdenum =num*ri01*v01 ! valeur fct f au milieu de intervalle (a,b), cas pnt 0
		...
		fcim0101num=fcim0101num*num
		fci0101num=fci0101num*fcdenum
		fci0102num=fci0102num*fcdenum
		fcmi0102num=fcmi0102num*num
		fcmi0112num=fcmi0112num*num
		fci0112num=fci0112num*fcdenum
		
		fci0202num=fci0202num*fcdenum
		fci0212num=fci0212num*fcdenum
		fci1212num=fci1212num*fcdenum
			...
			reskim0101num = fcim0101num*wgk(8)
			reski0101num = fci0101num*wgk(8)
			reski0102num = fci0102num*wgk(8)
			reskmi0102num = fcmi0102num*wgk(8)
			reskmi0112num = fcmi0112num*wgk(8)
			reski0112num = fci0112num*wgk(8)
			
			reski0202num = fci0202num*wgk(8)
			reski0212num = fci0212num*wgk(8)
			reski1212num = fci1212num*wgk(8)
		...
		num = (su01**v01)*(su02**v02)/(su12**v12)
		f1denum =num*ri01*v01
		f1i01num=f1denum*si01
		f1i02num=f1denum*si02
		f1i12num=f1denum*si12
		f1m01num=num*sm01
		
		f1im0101num=f1im0101num*num
		f1i0101num=f1i0101num*f1denum
		f1i0102num=f1i0102num*f1denum
		f1mi0102num=f1mi0102num*num
		f1mi0112num=f1mi0112num*num
		f1i0112num=f1i0112num*f1denum
		
		f1i0202num=f1i0202num*f1denum
		f1i0212num=f1i0212num*f1denum
		f1i1212num=f1i1212num*f1denum
		...
		f2im0101num=f2im0101num*num
		f2i0101num=f2i0101num*f2denum
		f2i0102num=f2i0102num*f2denum
		f2mi0102num=f2mi0102num*num
		f2mi0112num=f2mi0112num*num
		f2i0112num=f2i0112num*f2denum
		
		f2i0202num=f2i0202num*f2denum
		f2i0212num=f2i0212num*f2denum
		f2i1212num=f2i1212num*f2denum
...
subroutine derivasplinesfirstderiv(b0,np0,npar0,bfix0,fix0,zi010,zi120,&
	...
	double precision,dimension(-2:(nz010-1))::the01,res2m01num,&
	res2i01num,i01,m01
	double precision,dimension(-2:(nz020-1))::the02,res2i02num, &
	i02,m02
	double precision,dimension(-2:(nz120-1))::the12,res2i12num, &
	i12,m12
	...
	allocate(zi01(-2:(nz010+3)),zi12(-2:(nz120+3)),zi02(-2:(nz020+3)))
	allocate(tronc01(-2:(nz010-1)),tronc02(-2:(nz020-1)))
	zi01=zi010
	zi02=zi020
	zi12=zi120
...
!write(6, *) "subject ",i
    ...
    if (nva12 .gt. 0) vet12 = dot_product(bh((npar0 - nva12 + 1) : npar0), ve12(i, 1:nva12))
			...
			if(nz01.GT.0) then
			res1(1:(nz01+2))=(res2m01num(-2:(nz01-1))-res2i01num(-2:(nz01-1)))* &
			vet01/u+ tronc01(-2:(nz01-1))
			end if 
...
!=============================================================================================  
!======================= Calculate second derivatives of loglik of splines baseline parameters ==========
!=============================================================================================  
...
!!write(6, *) "subject ",i
    ...
    if (nva12 .gt. 0) vet12 = dot_product(bh((npar0 - nva12 + 1) : npar0), ve12(i, 1:nva12))
				...
				if(nz02.GT.0) then
				res1((nz01+3):(nz02+nz01+4))=tronc02(-2:(nz02-1))-i02(-2:(nz02-1))*vet02
				end if 
			...
			do k=-2,(nz01-1)
			 ...
			 res1(m)=-res2im0101num(((k-1+3)*(nz01+2)+j+3))*(vet01**2)-&
			 res2im0101num(((j-1+3)*(nz01+2)+k+3))*(vet01**2)+&
			 res2i0101num(((k-1+3)*(nz01+2)+j+3))*(vet01**2)
			 ...
			 res1(m)=-res2mi0102num(((k-1+3)*(nz02+2)+j+3))*vet01*vet02+&
			 res2i0102num(((k-1+3)*(nz02+2)+j+3))*vet01*vet02
			 ...
			 res1(m)=res2mi0112num(((k-1+3)*(nz12+2)+j+3))*vet01*vet12 - &
			 res2i0112num(((k-1+3)*(nz12+2)+j+3))*vet01*vet12
			...
			do k=-2,(nz02-1)
			 ...
			 do j=k,(nz02-1)
			 u2=-res2i02num(j)*vet02
			 res1(m)=res2i0202num(((k-1+3)*(nz02+2)+j+3))*(vet02**2)
			 ...
			 do j=-2,(nz12-1)
			 u2=(res2i12num(j))*vet12
			 res1(m)=-res2i0212num(((k-1+3)*(nz12+2)+j+3))*vet02*vet12
			...
			do k=-2,(nz12-1)
			 ...
			 res1(m)=res2i1212num((k-1+3)*(nz12+2)+j+3)*(vet12**2)
			...
			if(nz02.GT.0) then
				res1((nz01+2+1):(nz02+nz01+4))=tronc02(-2:(nz02-1))-i02(-2:(nz02-1))*vet02
			end if 
			...
			if(nz02.GT.0) then
			 ...
			 res1((nz01+2+1):(nz02+nz01+4))=tronc02(-2:(nz02-1))- &
			 i02(-2:(nz02-1))*vet02
			...
			res1(1:(nz01+2))=(res2m01num(-2:(nz01-1))- &
			res2i01num(-2:(nz01-1)))* &
			vet01*(su12**vet12)-i01(-2:(nz01-1))*vet01* &
			(su01**vet01)*(su02**vet02)
			res1(1:(nz01+2))=res1(1:(nz01+2))/u1
			res1(1:(nz01+2))= res1(1:(nz01+2))+&
			tronc01(-2:(nz01-1))
			...
			res1((nz01+2+1):(nz02+nz01+4))=-res2i02num(-2:(nz02-1))* &
			vet02*(su12**vet12)-i02(-2:(nz02-1))*vet02*(su01**vet01)* &
			(su02**vet02)
			res1((nz01+2+1):(nz02+nz01+4))= &
			res1((nz01+2+1):(nz02+nz01+4))/u1
			res1((nz01+2+1):(nz02+nz01+4))= &
			...
			res1((nz01+nz02+5):(nz02+nz01+nz12+6))= &
			(res2i12num(-2:(nz12-1)))*vet12*(su12**vet12)-&
			i12(-2:(nz12-1))*vet12*(su12**vet12)*res2denum
			...
			vet02*(su12**vet12)*ri12*vet12+ &
			(m02(-2:(nz02-1))- & 
			i02(-2:(nz02-1))*ri02*vet02)*vet02*(su01**vet01)* &
			(su02**vet02)
			res1((nz01+2+1):(nz02+nz01+4))= &
			res1((nz01+2+1):(nz02+nz01+4))/u1
			res1((nz01+2+1):(nz02+nz01+4))= &
			...
			ri12*vet12+&
			(m12(-2:(nz12-1))- &
			i12(-2:(nz12-1))*ri12*vet12)*vet12*(su12**vet12)*res2denum
