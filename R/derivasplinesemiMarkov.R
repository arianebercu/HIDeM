...
derivasplinesemiMarkov<-function(b,npm,npar,bfix,fix,zi01,zi02,zi12,ctime,no,nz01,nz02,nz12,ve01,ve02,ve12,
                       dimnva01,dimnva02,dimnva12,nva01,nva02,nva12,
                       t0,t1,t2,t3,troncature){
  res<-rep(0,(npm*(npm+1)/2)+npm)
  .Fortran("derivasplinesemimark",
           ## input
           as.double(b),
           as.integer(npm),
           as.integer(npar),
...
derivasplinediagsemiMarkov<-function(b,npm,npar,bfix,fix,zi01,zi02,zi12,ctime,no,nz01,nz02,nz12,ve01,ve02,ve12,
                       dimnva01,dimnva02,dimnva12,nva01,nva02,nva12,
                       t0,t1,t2,t3,troncature){
  res<-rep(0,2*npm)
  .Fortran("derivasplinediagsemiMark",
           ## input
           as.double(b),
           as.integer(npm),
           as.integer(npar),
