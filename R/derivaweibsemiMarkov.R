...
derivaweibdiagsemiMarkov<-function(b,npm,npar,bfix,fix,ctime,no,ve01,ve02,ve12,
                     dimnva01,dimnva02,dimnva12,nva01,nva02,nva12,
                     t0,t1,t2,t3,troncature){
  res<-rep(0,2*npm)
  # return first and second derivatives of the loglik
 .Fortran("derivaweibdiagsemiMark",
           ## input
           as.double(b),
           as.integer(npm),
           as.integer(npar),
