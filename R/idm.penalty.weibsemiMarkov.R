...
idm.penalty.weibsemiMarkov<-function(b,fix0,size_V,
                             ...
                             .errorhandling = "remove")%dopar%{
                               ...
                               while(converged==F & ite<=maxiter){
                                 ...
                                 if(ite==0){# loglik penalised
                                   fn.value<-idmlLikelihoodweibpenasemiMarkov(b=b,
                                                                    npm=length(b),
                                                                    npar=size_V,
                                                                    bfix=bfix,
                                                                    fix=fix0,
                                ...
                                # update for beta 
                                 ...
                                 res<-idmlLikelihoodweibpenasemiMarkov(b=b,
                                                             npm=length(b),
                                                             npar=size_V,
                                                             bfix=1,
                                                             fix=rep(0,size_V),
                                 ...
                                 if(res %in%c(-1e9,1e9) | res < fn.value){
                                   ...
                                   sears<-searpas(vw=vw,
                                                  ...
                                                  b=beta,
                                                  delta=delta,
                                                  funcpa=idmlLikelihoodweibpenasemiMarkov,
                               ...
                               .errorhandling = "remove")%dopar%{
                                 ...
                                 while(converged==F & ite<=maxiter){
                                   ...
                                   # derivative of loglik
                                     ...
                                     output<-derivaweibdiagsemiMarkov(b=b,
                                                            npm=length(b),
                                                            npar=size_V,
                                                            bfix=bfix,
                                                            fix=fix0,
